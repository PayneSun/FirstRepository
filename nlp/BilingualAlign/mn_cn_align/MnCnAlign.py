...
# ---------------test-begin---------------#
# paragraph_2_statement('raw_data_cn.txt', 'cn')
# paragraph_2_statement('raw_data_mn.txt', 'mn')

# mn_cn_align('raw_data_mn.txt', 'raw_data_cn.txt')
...
def lists_combination(lists, code='-'):
    ...
    def myfunc(list1, list2):
        return [list([i, j]) for i in list1 for j in list2]

    return reduce(myfunc, lists)


# test_list = [[1,2,3], [4,5,6]]
# temp_list = lists_combination(test_list)
# print(temp_list)
...
# cn_paras_list = text_2_paragraph('raw_data_cn.txt')
# for i in range(len(cn_paras_list)):
#     cn_sents_list = para_2_sents_cn(cn_paras_list[i])
#     print(cn_sents_list)
#
#     if (len(cn_sents_list) > 2):
#         margin_by_n(cn_sents_list, len(cn_sents_list) - 1)
#     print(cn_sents_list)
#     print("\n")


bilingual_align('raw_data_mn.txt', 'raw_data_cn.txt', 'output.txt')
